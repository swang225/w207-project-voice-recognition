...
def load_split_data_alexa(metadata_path, frac=1, split=0.9):
    """
    split: is the fraction of data you want to use for training. 0.9 means 90%, rest is for test
    """
...
metadata_path = "C:/data/alexa/" # TODO: change to your location!
df_train, df_val = load_split_data_alexa(metadata_path, frac=frac, split=split)
